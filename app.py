...
# Инициализация переменных для выполнения задания, данные находятся
# по адресу https://github.com/kushedow/flask-html/blob/master/Project%201/data.py
title = "Stepik Travel"
...
def view_departure(departure):
    return render_template("departures.html", title=title, departures=departures, departure=departure, tours=tours)
